...
namespace SharedSource.RedirectModule.Helpers
{
    public static class Constants
    {
        ...
        public static class Settings
        {
            ...
            public static string RedirRuleMatch = "SharedSource.RedirectModule.RedirectionType.Rules";
        ...
        { 
            ...
            public static string RedirectRule = "Redirect Rule";
            public static string VersionedRedirectRule = "Versioned Redirect Rule";
